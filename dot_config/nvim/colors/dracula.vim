...
highlight DraculaBgLight guifg=NONE ctermfg=NONE guibg=#343746 ctermbg=237 gui=NONE cterm=NONE guisp=NONE
...
highlight DraculaBgDarker guifg=NONE ctermfg=NONE guibg=#1C1D25 ctermbg=235 gui=NONE cterm=NONE guisp=NONE
...
highlight DraculaYellowUnderline guifg=#F1FA8C ctermfg=228 guibg=NONE ctermbg=NONE gui=underline cterm=underline guisp=NONE
...
" LSP semantic tokens
hi! link @class DraculaCyanItalic
hi! link @struct DraculaCyanItalic
hi! link @enum DraculaCyanItalic
hi! link @enumMember DraculaOrange
hi! link @event DraculaCyanItalic
hi! link @interface DraculaCyanItalic
hi! link @modifier DraculaPink
hi! link @regexp DraculaYellow
hi! link @typeParameter DraculaOrange
hi! link @decorator DraculaGreenItalic

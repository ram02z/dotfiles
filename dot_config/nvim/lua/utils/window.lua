-- Copied from https://gitlab.com/yorickpeterse/nvim-window/
...
function M.pick()
  local windows = vim.tbl_filter(is_regular_window, api.nvim_tabpage_list_wins(0))

  -- Return if only one window
  if #windows == 1 then
    return
  end

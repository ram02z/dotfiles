...
if ! set -q prompt_prompt_symbol
    set -g prompt_prompt_symbol "❯"
end

if ! set -q prompt_prompt_symbol_error
    set -g prompt_prompt_symbol_error "❯"
end

if ! set -q prompt_prompt_symbol_color
    set -g prompt_prompt_symbol_color brgreen
end

if ! set -q prompt_prompt_symbol_error_color
    set -g prompt_prompt_symbol_error_color brred
end
